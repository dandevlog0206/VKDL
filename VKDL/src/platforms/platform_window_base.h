...
#include "../../include/vkdl/system/event_msg.h"
...
struct PlatformWindowBase
{
    ...
    void sendEventMsg(EventMsg& msg)
    {
        platform_window->OnEventMsgRecieved.invoke(*platform_window, msg);
        events.push(msg);
    }
